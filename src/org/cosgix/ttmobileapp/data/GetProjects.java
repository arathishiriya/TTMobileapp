...
/**
 * This class provides the projects from server
 * 
 * @author Sanjib
 *
 */
public class GetProjects implements IResponseHandler,IResponseParser{
	...
	/**
	 * method used to get the project download status
	...
	/**
	 * method used to set project download status
	 * @param downloadProjectsStatus
	 */
	...
	/**
	 * method used to get the list of projects
	 * @return projectList
	 */
